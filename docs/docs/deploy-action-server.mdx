...
## b. Connect Rasa Action Server to a Rasa Open Source deployment
...
1. Create a `rasa-values.yaml` file which will include configuration for the Rasa Open Source deployment.
...
2. Upgrade the Rasa Open Source deployment
