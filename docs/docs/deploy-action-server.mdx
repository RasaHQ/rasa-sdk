...
In the sections below you can learn how to deploy Rasa Action Server by using helm, and how to connect an Action Server deployment to Rasa Open Source.
...
## 2. Connect Rasa Action Server with Rasa Open Source deployment

If you have deployed your Rasa Assistant via the Rasa Helm chart, and you have deployed your Rasa Action Server as well.
Now it's time to connect them together. You can do this easily by following the steps:

1. Create the `rasa-values.yaml` file which will include configuration for Rasa Open Source deployment.
...
2. Upgrade a Rasa Open Source deployment
