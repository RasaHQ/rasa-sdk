...
from rasa_sdk.knowledge_base.utils import get_attribute_slots, reset_attribute_slots, \
    get_object_name, SLOT_MENTION, SLOT_OBJECT_TYPE, SLOT_LAST_OBJECT, \
    SLOT_LISTED_OBJECTS, SLOT_LAST_OBJECT_TYPE
...
def test_get_object_name(slots, use_last_object_mention, expected_object_name):
    ...
    actual_object_name = get_object_name(tracker, ordinal_mention_mapping, use_last_object_mention)
