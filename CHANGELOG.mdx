...
Rasa_Sdk 3.15.2 (2026-06-19)                             
### Bugfixes
- [#1344](https://github.com/rasahq/rasa-sdk/issues/1344): Widened the `websockets` dependency constraint from `>=10.0,<12.0` to `>=10.0,<16` to allow compatibility with newer `websockets` releases.


## [3.15.1] - 2026-02-18
                        
Rasa_Sdk 3.15.1 (2026-02-18)                             
### Bugfixes
- [#1293](https://github.com/rasahq/rasa-sdk/issues/1293): Update protobuf to 5.29.6 in response to CVE-2026-0994
