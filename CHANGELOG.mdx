...
Rasa_Sdk 3.7.2 (2024-01-08)                            
### Improvements
- [#1059](https://github.com/rasahq/rasa-sdk/issues/1059): Upgrade `sanic` and `sanic-testing`.
...
### Bugfixes
- [#1055](https://github.com/rasahq/rasa-sdk/issues/1055): Upgrade `Certifi` to fix Improper Following of a Certificate's Chain of Trust.
