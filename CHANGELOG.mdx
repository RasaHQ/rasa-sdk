...
## [major.minor.patch] - 2022-09-25
                                   
Rasa_Sdk major.minor.patch (2022-09-25)                                        
### Improved Documentation
- [#855](https://github.com/rasahq/rasa-sdk/issues/855): The `Rasa SDK` documentation has moved to the [Rasa Open Source repository](https://github.com/rasahq/rasa).
