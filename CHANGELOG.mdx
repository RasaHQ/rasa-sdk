...
## [2.8.11] - 2022-12-22
### Improvements
- [#912](https://github.com/rasahq/rasa-sdk/issues/912): With this release, the http payload must be compressed.
  You must use Rasa 2.8.34 or later, prior release are incompatible since they do not compress the payload.
