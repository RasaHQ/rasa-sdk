...
### Bugfixes
- [#1341](https://github.com/rasahq/rasa-sdk/issues/1341): Widened the `websockets` dependency constraint from `>=10.0,<12.0` to `>=10.0,<16` to allow compatibility with newer `websockets` releases.
