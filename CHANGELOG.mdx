...
Rasa_Sdk 3.14.2 (2026-06-19)                             
### Bugfixes
- [#1345](https://github.com/rasahq/rasa-sdk/issues/1345): Widened the `websockets` dependency constraint from `>=10.0,<12.0` to `>=10.0,<16` to allow compatibility with newer `websockets` releases.


## [3.14.1] - 2026-02-18
                        
Rasa_Sdk 3.14.1 (2026-02-18)                             
### Bugfixes
- [#1296](https://github.com/rasahq/rasa-sdk/issues/1296): Update protobuf to 5.29.6 to address CVE-2026-0994.
