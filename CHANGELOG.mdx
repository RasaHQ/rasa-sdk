...
Rasa_Sdk 3.16.2 (2026-06-19)                             
### Bugfixes
- [#1334](https://github.com/rasahq/rasa-sdk/issues/1334): Updated `idna`, `ujson`, `pip` and `urllib3` to address security vulnerabilities.
- [#1343](https://github.com/rasahq/rasa-sdk/issues/1343): Widened the `websockets` dependency constraint from `>=10.0,<12.0` to `>=10.0,<16` to allow compatibility with newer `websockets` releases.
